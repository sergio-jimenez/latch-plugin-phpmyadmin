...
require_once '/plugins/latch/Error.php';
require_once '/plugins/latch/Latch.php';
require_once '/plugins/latch/LatchResponse.php';
require_once '/plugins/latch/latchConfiguration.php';
